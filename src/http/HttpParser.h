...
public:
    ...
    const char* get_param_value(const char* p_name);
    const char* get_header_value(const char* p_name);
...
private:
	...
	uint32_t            chunk_read_length_;
	
	uint32_t            total_read_length_;
